            ...
            <tbody>
              ...
              foreach ($category_all as $value) { ?>
                ...
                <tr>
                  ...
                  <td class="btn1">
                    <a href="index.php?act=update_category&category_id=<?php echo $value['category_id'] ?>">
                      <input class="btn btn-gradient-primary btn2" type="button" value="Sửa">
                    </a>
                    <a href="index.php?act=delete_category&category_id=<?php echo $value['category_id'] ?>" onclick="return confirm(`Bạn muốn xóa?`)" id="delete">
