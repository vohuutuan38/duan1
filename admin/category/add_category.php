      ...
      <div class="card-body">
        ...
        <form class="forms-sample" action="index.php?act=add_category" method="POST">
          <div class="form-group">
            ...
            <input disabled name="category_id" type="text" class="form-control">
          </div>
          <div class="form-group">
            <label for="">Tên loại
            </label>
          ...
          <div class="form-group mt-3">
            <input class="btn btn-gradient-primary me-2" type="submit" name="btn_add_category" value="Thêm mới">
