      ...
      <div class="card-body">
        ...
        <form action="index.php?act=update_account" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="radio" class="form-check-input" name="role" value="customer" <?php echo $role == 'customer' ?  'checked' : false ?>> Khách hàng
            <input type="radio" class="form-check-input role" name="role" value="admin" <?php echo $role == 'admin' ?  'checked' : false ?>> Admin
          </div>
