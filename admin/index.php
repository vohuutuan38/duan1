...
if (isset($_GET['act'])) {
    ...
    switch ($act) {
        ...
        case 'update_category':
            $category_id = $_GET['category_id'];
            $category_one = category_one($category_id);
        ...
        case 'add_product':
            if (isset($_POST['themmoi']) && ($_POST['themmoi'])) {
                ...
                $color = $_POST['color'];
                $size = $_POST['size'];
                insert_product($product_name, $price, $image, $description, $category_id, $quantity, $color, $size);
        ...
        case 'list_product':
            if (isset($_POST['search_dm']) && ($_POST['search_dm'])) {
                ...
                array_push($_SESSION['category'], $category_id);
            } else {
                $kyw = '';
                $category_id = 0;
            }

            $list_category = category_all();
            $count_product = count(loadall_product(isset($_SESSION['kyw'][0]) ? $_SESSION['kyw'][0] : '', isset($_SESSION['category'][0]) ? $_SESSION['category'][0] : ''));
            // echo $count_product;
            $page = ceil($count_product / 7);
            $list_product = loadall_product_admin(isset($_SESSION['kyw'][0]) ? $_SESSION['kyw'][0] : '', isset($_SESSION['category'][0]) ? $_SESSION['category'][0] : '', $page);
